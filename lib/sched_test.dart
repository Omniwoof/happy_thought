...
class SchedHomePage extends StatefulWidget {
  @override
  _SchedHomePageState createState() => new _SchedHomePageState();
}

class _SchedHomePageState extends State<SchedHomePage> {
